...
-----------------------------------------------------------------------------
Fall 2019/Spring 2020  - Released Package 5D

			This package can be downloaded from pacsdisplay.org
				Update to remove dependencies on Expect
				Update for W10
				Remove support for antiquated photometers

-----------------------------------------------------------------------------
05/14/2021  - Released Package 5E

			This package can be downloaded from pacsdisplay.org
				Update includes updates to iQC
					New TG270 sQC and pQC test patterns (3 sizes of each)
				Update to gtest
					Adjustable window size
					Removed canvas border for full window assessment
				New program - ambtest
					Low contrast test object in black background
-----------------------------------------------------------------------------
01/10/2022  - Released Package 5F (minor)

			This package can be downloaded from pacsdisplay.org
				Update to include new version of spotread for more i1DisplayPro compatibility
-----------------------------------------------------------------------------
07/22/2022  - Released Package 5G

			This package can be downloaded from pacsdisplay.org
				Update includes updates to ambtest
					Bar pattern instead of oval to match other test patterns and Barten model
				Update to lumResponse
					Modified file save routine to avoid so much clicking
					Most Windows installs prevent mkdir command from working anyway
				New program - uniLum
					Included in pdQC, software dedicated to measuring and analyzing luminance uniformity
					Can measure 1, 3, or 18 luminance points at 9 display locations
-----------------------------------------------------------------------------
