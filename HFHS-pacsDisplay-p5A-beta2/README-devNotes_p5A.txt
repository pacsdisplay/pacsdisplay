...
ToDo        - lumResponse, "ActiveState basekit has stopped working" error when record button pushed.
...
ToDo        - loadLUT-dicom executing from the startup folder on zibing (W7)
